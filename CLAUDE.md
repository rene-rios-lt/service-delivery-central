...
| `audit-skills/` | `/audit-skills` | Full audit of all pipeline skills — ratings across 7 dimensions, strengths, weaknesses, inconsistencies, contradictions, improvement backlog |
